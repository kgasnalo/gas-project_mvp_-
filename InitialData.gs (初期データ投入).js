...
function insertContactHistoryData() {
  try {
    ...
    testData.push(
      ...
      ['CONT-C001-002', 'C001', '田中太郎', new Date(2025, 8, 22, 15, 30), '面談', '佐藤課長', 'カジュアル面談。会社説明と質疑応答', new Date(2025, 8, 29)],
      ...
      ['CONT-C001-008', 'C001', '田中太郎', new Date(2025, 10, 10, 10, 0), '面談', '山田部長', '内定条件の提示と質疑応答', null]
    );

    // C002: 5件（標準的な接点）
    testData.push(
      ['CONT-C002-001', 'C002', '佐藤花子', new Date(2025, 8, 20, 14, 0), 'メール', '田中リクルーター', '初回コンタクト', new Date(2025, 9, 3)],
      ['CONT-C002-002', 'C002', '佐藤花子', new Date(2025, 9, 5, 15, 0), '面談', '佐藤課長', 'カジュアル面談', new Date(2025, 9, 19)],
    ...
    testData.push(
      ...
      ['CONT-C003-002', 'C003', '鈴木一郎', new Date(2025, 8, 24, 15, 0), '面談', '佐藤課長', 'カジュアル面談', new Date(2025, 8, 30)],
      ...
      ['CONT-C003-010', 'C003', '鈴木一郎', new Date(2025, 10, 12, 10, 0), '面談', '山田部長', '内定条件提示', null]
    );

    // C004: 3件（接点少ない）
    testData.push(
      ['CONT-C004-001', 'C004', '高橋美咲', new Date(2025, 8, 25, 14, 0), 'メール', '田中リクルーター', '初回コンタクト', new Date(2025, 9, 15)],
      ['CONT-C004-002', 'C004', '高橋美咲', new Date(2025, 9, 18, 15, 0), '面談', '佐藤課長', 'カジュアル面談', new Date(2025, 10, 9)],
    ...
    testData.push(
      ...
      ['CONT-C005-002', 'C005', '渡辺健太', new Date(2025, 9, 4, 15, 0), '面談', '佐藤課長', 'カジュアル面談', new Date(2025, 9, 14)],
